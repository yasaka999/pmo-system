...
from app.api.v1 import auth, projects, milestones, issues_risks, mandays, reports, sys_dicts, users, weekly_progress, admin, operation_logs
...
api_router.include_router(admin.router, prefix="", tags=["管理员功能"])
...
api_router.include_router(weekly_progress.router, prefix="", tags=["周报进展"])
